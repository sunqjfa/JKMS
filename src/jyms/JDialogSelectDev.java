 ...
 * @author John
 */
public class JDialogSelectDev extends javax.swing.JDialog {
    
    private final String sFileName = this.getClass().getName() + ".java";
    private DefaultTableModel deviceManagedTableModel ;
    int iCurrentRow = -1;
    /**
     ...
     * @param modal
     */
    public JDialogSelectDev(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        modifyLocales();
        initialFrameParas();
    ...
    public JDialogSelectDev(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        modifyLocales();
        initialFrameParas();
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabelPass.setFont(new java.awt.Font("微软雅黑", 0, 16)); // NOI18N
        jLabelPass.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabelPass.setText("密码：");

        jPasswordFieldDev.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jPasswordFieldDevKeyTyped(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jLabelSelectDev, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(23, 23, 23)
...
//            }
//        }
        iCurrentRow = jTableDeviceManaged.getSelectedRow();
        if (iCurrentRow < 0) iCurrentRow = -1;
        else{
            String sPassword = new String(jPasswordFieldDev.getPassword());
            String sPassword2 = (String)jTableDeviceManaged.getValueAt(iCurrentRow,4);
            if (!(sPassword.equals(sPassword2))) {
                JOptionPane.showMessageDialog(rootPane, sPasswordError);//"密码错误！"
    ...
    private void jPasswordFieldDevKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jPasswordFieldDevKeyTyped
        // TODO add your handling code here:
        char Code = evt.getKeyChar();
        if (Code == KeyEvent.VK_ENTER){
            jButtonOK.doClick();
        }
    }//GEN-LAST:event_jPasswordFieldDevKeyTyped
...
//                deviceManagedTableModel.getDataVector().add(newRow);
    ...
    */
    private DefaultTableModel initialDeviceManagedTableModel()
    {
        //String tabeTile[];
        //tabeTile = new String[] {"设备","IP地址","端口号","用户名","密码"};
        DefaultTableModel  DeviceManagedTableModel =CommonParas.initialNormalNoEditTableModel(tableTitle);//new JTableCheckBoxModel(tabeTile);
    ...
    */
    private void setTableColWidth(){
        ...
        tcmDeviceManaged.getColumn(0).setMaxWidth(160);
        tcmDeviceManaged.getColumn(0).setPreferredWidth(160);
        
//        tcmDeviceManaged.getColumn(1).setMinWidth(0);
//        tcmDeviceManaged.getColumn(1).setMaxWidth(0);
//        tcmDeviceManaged.getColumn(1).setWidth(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogSelectDev.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogSelectDev dialog = new JDialogSelectDev(new javax.swing.JFrame(), true);
    ...
    */
    private void modifyLocales(){
        ...
        //信息显示
        tableTitle = Locales.getString("ClassStrings", "JDialogSelectDev.tableTitle").split(",");  //设备,IP地址,端口号,用户名,密码
        sTitle = Locales.getString("ClassStrings", "JDialogSelectDev.sTitle");  //选择设备
        sPasswordError = Locales.getString("ClassStrings", "JDialogSelectDev.sPasswordError");  //密码错误！
        //标签和按钮显示
        jLabelSelectDev.setText( Locales.getString("ClassStrings", "JDialogSelectDev.jLabelSelectDev"));  //设备列表：
        jLabelPass.setText( Locales.getString("ClassStrings", "JDialogSelectDev.jLabelPass"));  //密码：
        jButtonOK.setText( Locales.getString("ClassStrings", "JDialogSelectDev.jButtonOK"));  //确定
        jButtonCancel.setText( Locales.getString("ClassStrings", "JDialogSelectDev.jButtonCancel"));  //取消
    ...
    private String[] tableTitle = new String[] {"设备","IP地址","端口号","用户名","密码"};
    private String sTitle = "选择设备";
